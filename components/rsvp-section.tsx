        ...
        >
          ...
          <div className="text-center">
            <button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 md:px-10 py-2.5 sm:py-3 md:py-3.5 border-2 border-black bg-black text-white hover:bg-white hover:text-black transition-all duration-300 flex items-center justify-center gap-2 font-montserrat text-xs sm:text-sm md:text-base uppercase tracking-wider mx-auto cursor-pointer active:scale-95 active:opacity-80 touch-manipulation"
            >
